...
win = font1.render('Хьом Чимаев ву!', True, (255, 0, 0))
lose = font1.render('Ставка не зашла?!', True, (255, 0, 0))
...
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 60, 60, randint(1, 5))
